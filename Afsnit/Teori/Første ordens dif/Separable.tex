...
En \textit{separabel differentialligning} er enhver ligning, der kan udtrykkes på formen $\displaystyle\frac{dx}{dt}=h(t)g(x)$.

\begin{defn}\textbf{Separabel differentialligning}\label{Separable_differentialligning_defn}\cite[s.92]{"AICNDE"}
\newline
Lad $h\in C^0(I,\R)$ og $g\in C^0(\R, \R)$.
