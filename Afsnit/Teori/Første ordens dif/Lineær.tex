...
\begin{equation*}
    f(x)=q(t), \quad t \in I
\end{equation*}
hvor $q : I \rightarrow \R$ er en funktion, der afhænger af $t$, og $x : I \rightarrow \R$ er den ukendte funktion. $f \in C^n(\R, \R^n)$, hvor $f: \R \rightarrow \R^n$, er en lineær afbildning fra $\R$ til $\R^n$. Når $f$ er en lineær afbildning, vil differentialligningen være lineær.\\
...
\end{itemize}
altså hvis $f : \R \rightarrow \R$ er en lineær afbildning, hvor $n$ angiver differentialligningens orden. $x, x_1, x_2$ er løsninger til differentialligningen, og $c \in \R$ er en skalar.
\end{defn}
