...
\newline
Lad $D_f \subseteq \R \times \R$ være en åben ikke-tom delmængde. Lad $f \in C^1(D_f,\R)$ og $(t_0, x_0) \in D_f$. Så er begyndelsesværdiproblemet givet ved 
\begin{align*}
...
Lad $D_f \subseteq \R \times \R$ være en åben ikke-tom delmængde. Lad \textit{a} være en konstant og $f \in C^1(D_f, \R)$. Da vil begyndelsesværdiproblemet 
