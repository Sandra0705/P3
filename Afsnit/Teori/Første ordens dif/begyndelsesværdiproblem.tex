...
\newline
Lad $D_f \subseteq I \times \R$ være en åben ikke-tom delmængde og $f \in C^0(D_f,\R)$. Så er begyndelsesværdiproblemet givet ved 
\begin{align*}
    \frac{dx}{dt} = f(t, x), \quad x(t_0) = x_0
\end{align*}
hvor $t\in I$ og $x\in C^1(I,\R)$. \textit{Begyndelsesbetingelsen} er $x(t_0) = x_0$.
\end{defn}
...
Lad $a \in \R$ være en konstant. Lad $D_f \subseteq \R \times \R$ være en åben ikke-tom delmængde og lad $f \in C^0(D_f, \R)$. Da vil begyndelsesværdiproblemet 
